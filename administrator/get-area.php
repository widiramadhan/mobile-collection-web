				...
				<form action="" method="post">
					...
					<div class="form-group">
						...
						<select class="form-control" id="col1" name="col1">
							<option value="" selected>Pilih Collector 1 </option>
							<?php
								if($data['LEVEL'] == 'SUPER ADMIN'){
					...
					<table class="table table-bordered dataTable" style="width:100%;" id="example" >
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:left;"><a href="index.php?page=aro-activity&id=<?php echo $dataDKHC['M_AREA_COLL_ID'];?>" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> Detail</a>
								</td>
							</tr>
								<?php } } ?>
						</tbody>
