			...
			<div class="card-body">
				<table class="table" style="border:none;">
					<tr>
						...
						<td style="text-align:left;font-weight:bold"><label><?php echo $total_paid;?></label></td>
					</tr>
					<tr>
						<td style="text-align:left;">Jumlah customer yang janji bayar</td>
						<td style="text-align:left;">:</td>
						<td style="text-align:left;font-weight:bold"><label><?php echo $total_promise;?></label></td>
					</tr>
					<tr>
